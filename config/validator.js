...
const userSignUpValidationRules = () => {
  return [
    check("name", "Please fill in your name").not().isEmpty(),
    check("email", "Please fill in your email address").not().isEmpty().isEmail(),
...
const userSignInValidationRules = () => {
  return [
    ...
    check("password", "Please enter your password").not().isEmpty().isLength({ min: 4 }),
  ];
};
